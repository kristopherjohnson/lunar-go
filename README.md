...
This is a port of a classic text-based ["lunar lander" game][lunarlander] to [Go][go].
...
I did some research, and I found the [original Lunar Lander program by Jim Storer][storerlunarlander], written in the [FOCAL programming language][wpfocal] in 1969.  I've rewritten it in Go so that it can be built and run on modern systems.  The program here is pretty close to what I remember.  One difference is that, on crashing into the moon surface, that program announced "IT'S ALL OVER BUT THE SHOUTING", which confused me as a ten-year-old.  I thought the shouting was for joy.
...
If you have Go installed, you can build and run the game by executing this command:
